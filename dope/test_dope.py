...
class TestDopeCreateSessionTab(unittest.TestCase):
    ...
    def test_render_create_session_tab_basic(self, mock_info, mock_subheader):
        ...
        with patch('chronograph.service.ChronographService') as mock_chrono_service, \
             patch('weather.service.WeatherService') as mock_weather_service:
...
class TestDopePageStructure(unittest.TestCase):
    ...
    def test_dope_page_exists(self):
        ...
        page_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pages", "2_📊_DOPE.py")
    ...
    def test_dope_page_has_required_imports(self):
        ...
        if os.path.exists(page_path):
            ...
            required_imports = ["streamlit", "handle_auth", "create_client", "render_create_session_tab"]
            for required_import in required_imports:
                self.assertIn(required_import, content, f"DOPE page should import {required_import}")

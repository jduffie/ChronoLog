...
| bore_diameter_land_mm           | text                     | bullets                    | YES          | \-          | from bullet table                                                                                                                                                                             |   |
...
| cartridge_type                  | text                     | cartridge_specs_unified_mv | NO           | \-          | Type of cartridge ('6mm Creedmore', '22LR', etc)                                                                                                                                              |   |
| cartridge_make                  | text                     | cartridge_specs_unified_mv | NO           | \-          | creator of the cartridge                                                                                                                                                                      |   |
| cartridge_model                 | text                     | cartridge_specs_unified_mv | NO           | \-          | model                                                                                                                                                                                         |   |
...
| cartridge_spec_id               | uuid                     | dope_sessions              | NO           |             | provided by the user when session created -                                                                                                                                                   |   |
...
- **cartridge_specs_unified_mv(id)** - materialized view that is a union of the factory_cartridge_specs or custom_cartridge_specs table

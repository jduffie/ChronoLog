...
class TestDopeService(unittest.TestCase):
    ...
    def test_get_session_by_id(self):
        ...
        found_session = self.service.get_session_by_id(target_session_id, self.test_user_id)
    ...
    def test_get_session_by_id_not_found(self):
        ...
        found_session = self.service.get_session_by_id("nonexistent_id", self.test_user_id)
    ...
    def test_filter_sessions_by_status(self):
        ...
        active_sessions = self.service.filter_sessions(self.test_user_id, {"status": "active"})
        self.assertGreater(len(active_sessions), 0)
        for session in active_sessions:
            self.assertEqual(session.status, "active")
            
        # Filter for archived sessions
        archived_sessions = self.service.filter_sessions(self.test_user_id, {"status": "archived"})
    ...
    def test_filter_sessions_by_cartridge_type(self):
        ...
        sessions = self.service.filter_sessions(self.test_user_id, {"cartridge_type": "223 Remington"})
    ...
    def test_filter_sessions_by_rifle_name(self):
        ...
        sessions = self.service.filter_sessions(self.test_user_id, {"rifle_name": "AR-15 SPR"})
    ...
    def test_get_unique_values(self):
        ...
        cartridge_types = self.service.get_unique_values(self.test_user_id, "cartridge_type")
    ...
    def test_update_session(self):
        ...
        updated_session = self.service.update_session(session_to_update.id, update_data, self.test_user_id)
    ...
    def test_update_nonexistent_session(self):
        ...
        with self.assertRaises(Exception) as context:
            self.service.update_session("nonexistent_id", update_data, self.test_user_id)
...
class TestDopeViewPage(unittest.TestCase):
    ...
    def test_get_filtered_sessions_with_search(self):
        ...
        with patch('streamlit.error'):
            ...
            if sessions:
                ...
                found_federal = any("Federal" in str(s.__dict__.values()) for s in sessions)
    ...
    def test_render_sessions_table_with_data(self):
        ...
        with patch('streamlit.dataframe') as mock_dataframe, \
            ...
            call_args = mock_df.call_args_list[0][0][0]  # Get the data passed to DataFrame
    ...
    def test_render_session_details_structure(self):
        ...
        with patch('streamlit.subheader'), \
             ...
             patch('streamlit.button'), \
             patch('streamlit.tabs', return_value=[MagicMock(), MagicMock(), MagicMock(), MagicMock(), MagicMock()]), \
             patch('streamlit.info'), \
             patch('streamlit.write'), \

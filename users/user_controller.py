...
class UserController:
    ...
    def handle_profile_setup(self, user: Dict[str, Any], existing_profile: Optional[Dict[str, Any]] = None) -> Optional[Dict[str, Any]]:
        ...
        if form_data:
            ...
            if success:
                ...
                self.view.display_error_message("Failed to save profile. Please try again.")
        
        return None

    def _validate_form_data(self, form_data: Dict[str, Any], current_email: str) -> list[str]:
    ...
    def get_complete_user_profile(self, user: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def handle_user_management_admin(self) -> None:
        ...
        if action_result and action_result["action"] == "delete":
            ...
            if selected_indices:
                ...
                confirmation = self.view.display_delete_confirmation(users, selected_indices)
                ...
                if confirmation == "confirm":
                    ...
                    if deleted_count > 0:
                        self.view.display_success_message(f"Successfully deleted {deleted_count} user(s)")
                        st.rerun()
                    else:
    ...
    def get_user_stats(self) -> Dict[str, Any]:
        ...
        # Calculate stats
        imperial_users = len([u for u in all_users if u.get("unit_system") == "Imperial"])

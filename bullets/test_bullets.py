...
class TestBulletModel(unittest.TestCase):
    ...
    def test_bullet_model_display_name_variations(self):
        ...
        self.assertEqual(bullet.display_name, "Hornady ELD-M - 147.5gr - 6.5mm")
    ...
    def test_bullet_model_field_types(self):
        ...
        if bullet.ballistic_coefficient_g1 is not None:
            self.assertIsInstance(bullet.ballistic_coefficient_g1, (int, float))
    ...
    def test_bullet_model_to_dict_excludes_id(self):
        ...
        expected_fields = [
            ...
            "bullet_diameter_groove_mm", "bore_diameter_land_mm", "bullet_length_mm",
...
class TestBulletsService(unittest.TestCase):
    ...
    def test_get_unique_manufacturers_database_error(self):
        ...
        with patch.object(self.service, "get_all_bullets") as mock_get_all:
            ...
            self.assertIn("Error getting manufacturers", str(context.exception))
    ...
    def test_get_unique_bore_diameters_database_error(self):
        ...
        with patch.object(self.service, "get_all_bullets") as mock_get_all:
            ...
            self.assertIn("Error getting bore diameters", str(context.exception))
...
class TestBulletsIntegration(unittest.TestCase):
    ...
    def test_csv_data_to_model_conversion(self):
        ...
        self.assertEqual(bullet.display_name, "Sierra MatchKing - 123.0gr - 6.71mm")
    ...
    def test_service_model_integration(self):
        ...
        self.assertEqual(hornady_bullet.display_name, "Hornady ELD-M - 147gr - 6.5mm")
        ...
        self.assertEqual(federal_bullet.display_name, "Federal Gold Medal - 168gr - 7.82mm")
    ...
    def test_filter_and_unique_values_integration(self):
        ...
        all_bullets_data = [
            {
                "id": "6mm-1", "user_id": "admin", "manufacturer": "Hornady", "model": "ELD-M",
                "weight_grains": 108, "bullet_diameter_groove_mm": 6.5, "bore_diameter_land_mm": 6.0,
                "bullet_length_mm": None, "ballistic_coefficient_g1": None, "ballistic_coefficient_g7": None,
                "sectional_density": None, "min_req_twist_rate_in_per_rev": None, "pref_twist_rate_in_per_rev": None,
                "data_source_name": None, "data_source_url": None,
            },
            {
                "id": "308-1", "user_id": "admin", "manufacturer": "Federal", "model": "Gold Medal",
                "weight_grains": 168, "bullet_diameter_groove_mm": 7.82, "bore_diameter_land_mm": 7.62,
                "bullet_length_mm": None, "ballistic_coefficient_g1": None, "ballistic_coefficient_g7": None,
                "sectional_density": None, "min_req_twist_rate_in_per_rev": None, "pref_twist_rate_in_per_rev": None,
                "data_source_name": None, "data_source_url": None,
            },
            {
                "id": "6mm-2", "user_id": "admin", "manufacturer": "Hornady", "model": "ELD-X",
                "weight_grains": 103, "bullet_diameter_groove_mm": 6.5, "bore_diameter_land_mm": 6.0,
                "bullet_length_mm": None, "ballistic_coefficient_g1": None, "ballistic_coefficient_g7": None,
                "sectional_density": None, "min_req_twist_rate_in_per_rev": None, "pref_twist_rate_in_per_rev": None,
                "data_source_name": None, "data_source_url": None,
            }
        ...
        mock_filter_response.data = [all_bullets_data[0], all_bullets_data[2]]  # Only Hornady bullets
    ...
    def test_real_world_dataset_processing(self):
        ...
        self.assertEqual(bullet_dict["data_source_url"], "https://www.sierrabullets.com/product/6-5mm-264-cal-123-gr-matchking-hpbt/")
...
class TestBulletsTabIntegration(unittest.TestCase):
    ...
    def test_create_tab_admin_access_integration(self, mock_header, mock_form, mock_service_class):
    ...
    @patch('streamlit.header')
    def test_create_tab_non_admin_access_integration(self, mock_header, mock_info, mock_warning, mock_service_class):
        ...
        mock_warning.assert_called_with("🔒 Access Denied: Only administrators can create bullet entries.")
        mock_info.assert_called_with("This global bullet database is maintained by administrators to ensure data quality and consistency.")

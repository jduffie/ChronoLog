...
class TestAmmoCreateTab(unittest.TestCase):
    ...
    def test_render_create_ammo_tab_basic(self, mock_submit, mock_selectbox, 
    ...
    def test_render_create_ammo_tab_submit_success(self, mock_success, mock_submit, 
...
class TestAmmoPageStructure(unittest.TestCase):
    ...
    def test_ammo_page_exists(self):
        ...
        page_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pages", "6_📦_Ammo.py")
    ...
    def test_ammo_page_has_required_imports(self):
        ...
        if os.path.exists(page_path):
            ...
            required_imports = ["streamlit", "handle_auth", "create_client", "render_create_ammo_tab"]
            for required_import in required_imports:
                self.assertIn(required_import, content, f"Ammo page should import {required_import}")

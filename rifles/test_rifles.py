...
class TestRiflesCreateTab(unittest.TestCase):
    ...
    def test_render_create_rifle_tab_basic(self, mock_submit, mock_selectbox,
                                         mock_number_input, mock_text_input,
                                         mock_form, mock_subheader):
        ...
        mock_number_input.side_effect = [24, 1.0, 10.0, 2.5]  # barrel_length, twist_ratio, trigger_weight, sight_offset
    ...
    def test_render_create_rifle_tab_submit_success(self, mock_success, mock_submit,
                                                  mock_selectbox, mock_number_input,
                                                  mock_text_input, mock_form, mock_subheader):
        user = {'email': 'test@example.com', 'name': 'Test User'}
        mock_supabase = Mock()
...
class TestRiflesPageStructure(unittest.TestCase):
    ...
    def test_rifles_page_exists(self):
        ...
        page_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pages", "7_📏_Rifles.py")
    ...
    def test_rifles_page_has_required_imports(self):
        ...
        if os.path.exists(page_path):
            ...
            required_imports = ["streamlit", "handle_auth", "create_client", "render_create_rifle_tab"]
            for required_import in required_imports:
                self.assertIn(required_import, content, f"Rifles page should import {required_import}")
